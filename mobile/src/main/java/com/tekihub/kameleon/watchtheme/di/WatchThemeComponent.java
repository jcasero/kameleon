...
@WatchThemeScope @Component(dependencies = ApplicationComponent.class, modules = {
    WatchThemeModule.class, UsageModule.class, CommunicationModule.class, ThemeModule.class
