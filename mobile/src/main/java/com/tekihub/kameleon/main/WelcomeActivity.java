...
public class WelcomeActivity extends BaseActivity {
    ...
    protected void onResume() {
        ...
        addFragment(
                ...
                AppUsageUtils.isAppUsageEnabled(getApplicationContext()) ?
                        BaseFragment.newInstance(this, WelcomeFragment.class) :
                        BaseFragment.newInstance(this, AppUsageFragment.class)
        );
