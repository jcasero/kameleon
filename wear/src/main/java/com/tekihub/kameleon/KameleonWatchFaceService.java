...
public class KameleonWatchFaceService extends CanvasWatchFaceService {
    ...
    private class KameleonWatchFaceEngine extends CanvasWatchFaceService.Engine
        implements DataApi.DataListener, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, WatchfaceInvalidator.OnInvalidateListener {
        ...
        private GoogleApiClient mGoogleApiClient =
            new GoogleApiClient.Builder(KameleonWatchFaceService.this).addConnectionCallbacks(this)
        ...
        private void initializeWatchFaceStyle() {
            setWatchFaceStyle(new WatchFaceStyle.Builder(KameleonWatchFaceService.this).setCardPeekMode(
                WatchFaceStyle.PEEK_MODE_SHORT)
